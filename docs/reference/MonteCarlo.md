...
Passage Times make start to make sense if you plot Bounded Paths and
count the number of paths that have crossed the threshold. Even in
journal articles, the method section begins with a Monte Carlo
simulation.
