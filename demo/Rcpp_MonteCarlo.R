...
# m=100,skip=1,paths=1000000,seed=99,engine=1
stdnorm <- RcppOUPMCStandardNormal(100,1,1000000,99,1)
# x=20,m=100,skip=1,dt=0.1,rho=0.5,mu=-15,sigma=15,method=5
forward <- RcppOUPMCForwardPaths(stdnorm,20,100,1,0.1,0.5,-15,15,5)
