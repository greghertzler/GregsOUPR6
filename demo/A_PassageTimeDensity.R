...
pt <- A$PassageTimeDensity(t=seq(from=0,to=2,by=0.02),z=seq(from=-20,to=10,by=0.3))
# vertical axis
A$PlotPassageTimeDensity(ptmax=1.2)
# using set and plot
...
A$PlotPassageTimeDensity(title="type=-1",type=-1)
A$PlotPassageTimeDensity(title="type=0 (default)",type=0)
