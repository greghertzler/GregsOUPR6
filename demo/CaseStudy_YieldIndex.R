...
FD$PlotOption(type=1,title="Yield Index",xaxis="Apr-Oct (mm)")
# estimate continuous wheat
ML$Estimates(df,taucol=1,zcol=11)
# put option
A$Option(s=seq(from=0,to=1,by=0.01),x=seq(from=230,to=1030,by=8),t=1,y=654)
A$PlotOption(type=1,title="Put Option",xaxis="Wheat (kg/ha)")
